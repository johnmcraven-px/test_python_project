...
df = pd.DataFrame(all_data, columns=['Batch', 'Run', 'Performance', 'Time', 'ConstraintSatisfaction', 'FailureReason', 'ParetoScore'])

# Save data to CSV for later use in visualizations
df.to_csv('../data/viz_gen/optimization_results_2.csv', index=False)